...
func init() {
	register(AR, map[string]string{
		...
		"stack.back_all":               "كل الحزم",
		"stack.about_title":            "عن هذه الحزمة",
		"stack.services_title":         "خدمات هذه الحزمة",
		"stack.services_hint":          "صحة النسخ مباشرةً من العنقود؛ والمهام والسجلات والأوامر أحادية التنفيذ تُفتح لكل خدمة.",
		"stack.services_none_title":    "لا توجد خدمات",
		"stack.services_none_body":     "لا تشغّل العنقود أي خدمة لهذه الحزمة. إعادة الإطلاق تطبّق ملف التعريف وتجدولها.",
		"stack.services_unknown_title": "الخدمات غير متاحة",
		"stack.services_unknown_body":  "لم تُرجع واجهة API للعنقود خدمات هذه الحزمة، لذا صحة النسخ غير معروفة وليست فارغة.",
